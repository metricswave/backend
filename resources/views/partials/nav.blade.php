@if(false)
    <ul class="space-x-2 items-center hidden sm:flex">
                ...
                <div class="invisible opacity-0 absolute left-0 z-10 pt-2 w-[350px] origin-top-left focus:outline-none transition-all ease-out duration-500"
                    ...
                    <div class="py-2 bg-white shadow-lg ring-1 ring-black ring-opacity-5 rounded-md"
                        ...
                        <a href="#"
                           ...
                           id="menu-item-0">
                            Easy to Use<br/>
                            <span class="text-xs text-gray-500">but configurable analytics you'll love</span>
                        </a>
                        <a href="#"
                           class="text-zinc-700 block px-4 py-2 text-sm smooth hover:bg-zinc-100 hover:text-zinc-800"
                           role="menuitem"
                           tabindex="-1"
                           id="menu-item-0">
                            Improve SEO and User experience<br/>
                            <span class="text-xs text-gray-500">Reduce loading time and improve your SEO</span>
                        </a>
                        <a href="#"
                           class="text-zinc-700 block px-4 py-2 text-sm smooth hover:bg-zinc-100 hover:text-zinc-800"
                           role="menuitem"
                        ...
                        <div class="text-zinc-400 px-4 py-2 mt-4 text-sm">
        ...
        <li>
            <a href="/blog"
               class="px-3 py-2 hover:underline smooth">Blog</a>
        </li>
    </ul>
@endif
