...
@section('content')
    <div class="flex flex-col items-center justify-center space-y-14 sm:space-y-16">
        <div class="mx-auto flex flex-col space-y-8 mt-20 mb-8 sm:mt-40 sm:mb-8 max-w-[650px]">
            <h1 class="animate-[out_1s,_fade-in-down_1.5s_ease-out_1s] text-4xl sm:text-6xl text-center leading-tight sm:leading-tight tracking-tighter">
                <span class="relative bg-gradient-to-br from-pink-500 to-amber-500 bg-clip-text text-transparent">Time to leave</span>
                notifications
            </h1>
            ...
            <p class="animate-[out_1.25s,_fade-in-down_1.5s_ease-out_1.25s] text-center text-xl sm:text-2xl leading-normal sm:leading-normal opacity-70 sm:pb-6">
                based on live traffic data, you'll get a notification when it's time to leave for your next
                appointment.
            </p>
        ...
        <div class="animate-[out_2.5s,_fade-in-down_1.5s_ease-out_2.5s] mw-landing flex flex-col items-center mt-6 justify-center space-y-4">
            <div class="flex flex-row items-center justify-center">
                <h2>Don't be late for important appointments </h2>
                <svg width="25px"
                     height="25px"
                     class="ml-3 mt-1"
                     viewBox="0 0 24 24"
            ...
            <div class="mt-2">
                <img src="/images/landings/time-to-leave-notification.png"
                     class="dark:border dark:border-zinc-800 rounded mt-3 max-w-full w-[650px]"
                     title="Receive a notification on time to leave depending on live traffic or transit status">
            </div>
        </div>
        ...
        <div class="mw-landing flex flex-col sm:flex-row items-start justify-center space-y-12 sm:space-y-0 sm:space-x-32 py-12 sm:py-24 sm:text-center">
            <div class="flex flex-col space-y-3">
                ...
                <p>
                    You can customize the notification as you like. Set destination, origin, travel mode and more. Even
                    you have +8 params to customize the message and title.
                </p>
                <p class="pt-2">
                    <a href="/documentation/triggers/time-to-leave"
                       target="_blank"
                       class="hover:text-blue-500 underline smooth">Check
                        out all the available params →</a>
                </p>
            </div>
        </div>
