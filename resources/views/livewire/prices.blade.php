...
<div class="relative scroll-mt-10 sm:scroll-mt-16" id="pricing">
            ...
            <div class="sm:text-center text-zinc-500 pb-6 flex flex-col space-y-3 md:px-10 mb-8 max-w-[700px] mx-auto">
                <p>
                    <a href="https://app.metricswave.com"
                        class="border-b border-dotted border-blue-500 text-blue-500 smooth hover:text-blue-700 dark:hover:text-blue-300 hover:border-solid">{{ __('Start for free') }}</a>,
                    {{ __('and upgrade your account at any moment') }}.
                </p>
            </div>
        @endif
                ...
                @foreach (app(PlanGetter::class)->all() as $plan)
                    @php
                        ...
                        $link = match ($plan->name) {
                            ...
                            default
                                => 'https://app.metricswave.com?utm_source=metricswave&utm_medium=landing_prices&utm_campaign=pricing&utm_term=price_' .
                                $plan->id->value,
                        };
                    @endphp
                    ...
                    <a href="{{ $link }}"
                        ...
                        <h3 class="flex flex-row items-center justify-center text-center text-2xl font-light">
                            ...
                            @else
                                ...
                                <span
                                    class="text-base -ml-0.5 opacity-80">.{{ explode(',', number_format($plan->monthlyPrice / 100, 2, ',', '.'))[1] }}</span>
