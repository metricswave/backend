    ...
    public function daily(Location $location): WeatherForecasts
    {
        ...
        return new WeatherForecasts([
            ...
            new WeatherForecast(
                ...
                $data['daily']['apparent_temperature_min'][1],
                $data['daily']['sunrise'][1],
                $data['daily']['sunset'][1],
                $data['daily']['uv_index_max'][1],
                $data['daily']['uv_index_clear_sky_max'][1],
                $data['daily']['precipitation_sum'][1],
                $data['daily']['rain_sum'][1],
                $data['daily']['showers_sum'][1],
                $data['daily']['snowfall_sum'][1],
                $data['daily']['precipitation_hours'][1],
                $data['daily']['precipitation_probability_max'][1],
                $data['daily']['windspeed_10m_max'][1],
                $data['daily']['windgusts_10m_max'][1],
                $data['daily']['winddirection_10m_dominant'][1],
                $data['daily']['shortwave_radiation_sum'][1],
                $data['daily']['et0_fao_evapotranspiration'][1],
